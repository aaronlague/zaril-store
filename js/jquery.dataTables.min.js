    ...
    j.fn.dataTable = function(g) {
        ...
        function ya(a) {
            ...
            var b = p.createElement("div"),
                ...
                q = a.nTable.getElementsByTagName("tfoot").length === 0 ? null : a.nTable.getElementsByTagName("tfoot")[0],
        ...
        function Ba(a) {
            ...
            if (a.oScroll.sY === "")
                if (j.browser.msie && j.browser.version <= 7) d.style.height = u(a.nTable.offsetHeight + a.oScroll.iBarWidth);
        ...
        function wa(a) {
            ...
            b.innerHTML = a.oLanguage.sSearch + (a.oLanguage.sSearch === "" ? "" : " ") + '<label class="form-group input-group">' + '<input class="form-control input-group" type="text" />' + '<span class="input-group-btn"><button class="btn btn-default" type="button"> <i class="fa fa-search"></i></button></span>' + '</label>';
            var c = j("input", b);
        ...
        function va(a) {
            if (a.oScroll.bInfinite) return null;
            var b = '<select class="form-control" size="1" ' + (a.sTableId === "" ? "" : 'name="' + a.sTableId + '_length"') + ">",
                c, d;
        ...
        this.fnDestroy = function() {
            ...
            if (a.bJUI) {
                j("th", a.nTHead).removeClass([n.oStdClasses.sSortable, n.oJUIClasses.sSortableAsc,
                    n.oJUIClasses.sSortableDesc, n.oJUIClasses.sSortableNone
                ].join(" "));
